...
(function() {
  var Bookrack, Model, buildMetaData, buildModelInstanceProto, columnPropertyConfig, defineModelInstAttr, file2class, fs, joinPath, moduleExtRE, pathSep, readOnly, readOnlyEnum, ref, resolvePath, validModelNameER,
    slice = [].slice,
  ...
  defineModelInstAttr = function(instanceProto, protoProps, attr, column) {
    ...
    switch (column.type) {
      ...
      case 'column':
        ...
        return defInstAttr(columnPropertyConfig(column.def.columnName));
      default:
        throw new Error("Unknown model attribute type \"" + type + "\" for " + attr + ".");
    }
  };

  columnPropertyConfig = function(columnName) {
    return {
      get: function() {
        return this._bookshelfModelInst.get(columnName);
      },
      set: function(value) {
        return this._bookshelfModelInst.set(columnName, value);
      }
    };
  };
  ...
  Bookrack.Model = Model = (function() {
    function Model(bookrack, confFunc) {
      ...
      readOnly(this, '_tableName', (function(_this) {
        return function() {
          return protoProps.tableName;
        };
      })(this));
      ...
      this.columnInfo().then((function(_this) {
        return function(columns) {
          var attr, results;
          results = [];
          for (attr in columns) {
            if (!(/(^|_)id$/i.test(attr) || (instProto.$attrs[attr] != null))) {
              Object.defineProperty(instProto, attr, columnPropertyConfig(attr));
              results.push(readOnly(instProto.$attrs, attr, (function() {
                return 'column';
              }), true));
            } else {
              results.push(void 0);
      ...
      readOnly(this, '_ModelInstConstructor', (function(_this) {
        return function() {
          var klass;
          klass = (function() {});
    ...
    Model.prototype["new"] = function(attributes) {
      ...
      instance = new this._ModelInstConstructor;
    ...
    Model.prototype.columnInfo = function() {
      return this.$models._bookshelf.knex(this._tableName).columnInfo();
    };
